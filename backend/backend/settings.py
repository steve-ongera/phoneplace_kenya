...
SECRET_KEY = 'django-insecure-5le-y-qf4zi3+h8x^cvaeni6s*$8&x!z+z5v@-u%pa7tpx*hx^'
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'PhonePlace Kenya <info@phoneplacekenya.com>')
...
LOGGING = {
    ...
    'loggers': {
        ...
        'store': {'handlers': ['console', 'file'], 'level': 'DEBUG', 'propagate': False},
    },
}